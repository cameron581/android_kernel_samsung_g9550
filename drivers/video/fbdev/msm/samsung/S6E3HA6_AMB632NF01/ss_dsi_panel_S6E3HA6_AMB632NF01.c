...
#include "ss_dsi_mdnie_S6E3HA6_AMB632NF01.h"
...
static char mdss_panel_revision(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	switch (mdss_panel_rev_get(ctrl)) {
		case 0x00 ... 0x01:
			...
			LCD_INFO("Panel REV.A \n");
			break;
		case 0x02:
			vdd->panel_revision = 'B';
			LCD_INFO("Panel REV.B \n");
			break;
		case 0x03:
			vdd->panel_revision = 'E';
			LCD_INFO("Panel REV.E \n");
			break;
		default:
			vdd->panel_revision = 'E';
...
static char coordinate_data_2[][COORDINATE_DATA_SIZE] = {
	...
	{0xff, 0x00, 0xf7, 0x00, 0xf0, 0x00}, /* Tune_5 */
...
static int mdss_mdnie_read(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	if (get_panel_rx_cmds(ctrl, RX_MDNIE)->cmd_cnt) {
		...
		if (((vdd->mdnie_x[ctrl->ndx] - 2983) * (vdd->mdnie_x[ctrl->ndx] - 2983) + (vdd->mdnie_y[ctrl->ndx] - 3178) * (vdd->mdnie_y[ctrl->ndx] - 3178)) <= 225) {
			x = 0;
			y = 0;
		}
		else {
...
static char irc_hbm_para_revA[8][20] = {
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x64, 0x67, 0x64, 0x21, 0x22, 0x21, 0x21, 0x22, 0x21}, // 600  ( 365 ~ 365 )
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x60, 0x63, 0x60, 0x20, 0x21, 0x20, 0x20, 0x21, 0x20}, // 578  ( 351 ~ 364 )
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x5D, 0x5F, 0x5D, 0x1E, 0x20, 0x1E, 0x1E, 0x20, 0x1E}, // 555  ( 337 ~ 350 )
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x59, 0x5B, 0x59, 0x1D, 0x1F, 0x1D, 0x1D, 0x1E, 0x1D}, // 533  ( 324 ~ 336 )
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x55, 0x57, 0x55, 0x1C, 0x1E, 0x1C, 0x1C, 0x1D, 0x1C}, // 510  ( 310 ~ 323 )
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x51, 0x54, 0x51, 0x1B, 0x1C, 0x1B, 0x1B, 0x1B, 0x1B}, // 488  ( 296 ~ 309 )
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x4E, 0x50, 0x4E, 0x19, 0x1A, 0x19, 0x19, 0x1B, 0x19}, // 465  ( 282 ~ 295 )
	{0x0D, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x4A, 0x4C, 0x4A, 0x18, 0x19, 0x18, 0x18, 0x1A, 0x18}, // 443  ( 256 ~ 281 )
};

static char irc_hbm_para_revB[8][20] = {
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x64, 0x67, 0x64, 0x21, 0x22, 0x21, 0x21, 0x22, 0x21}, // 600  ( 365 ~ 365 )
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x60, 0x63, 0x60, 0x20, 0x21, 0x20, 0x20, 0x21, 0x20}, // 578  ( 351 ~ 364 )
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x5D, 0x5F, 0x5D, 0x1E, 0x20, 0x1E, 0x1E, 0x20, 0x1E}, // 555  ( 337 ~ 350 )
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x59, 0x5B, 0x59, 0x1D, 0x1F, 0x1D, 0x1D, 0x1E, 0x1D}, // 533  ( 324 ~ 336 )
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x55, 0x57, 0x55, 0x1C, 0x1E, 0x1C, 0x1C, 0x1D, 0x1C}, // 510  ( 310 ~ 323 )
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x51, 0x54, 0x51, 0x1B, 0x1C, 0x1B, 0x1B, 0x1B, 0x1B}, // 488  ( 296 ~ 309 )
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x4E, 0x50, 0x4E, 0x19, 0x1A, 0x19, 0x19, 0x1B, 0x19}, // 465  ( 282 ~ 295 )
	{0x61, 0xF0, 0x2D, 0x30, 0x3B, 0xBD, 0x33, 0x69, 0x12, 0x7A, 0xE0, 0x4A, 0x4C, 0x4A, 0x18, 0x19, 0x18, 0x18, 0x1A, 0x18}, // 443  ( 256 ~ 281 )
};

static char irc_hbm_para_revE[8][20] = {
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x99, 0x99, 0x99, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33}, // 600  ( 365 ~ 365 )
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x99, 0x99, 0x99, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33}, // 578  ( 351 ~ 364 )
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x99, 0x99, 0x99, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33}, // 555  ( 337 ~ 350 )
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x99, 0x99, 0x99, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33}, // 533  ( 324 ~ 336 )
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x99, 0x99, 0x99, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33}, // 510  ( 310 ~ 323 )
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x99, 0x99, 0x99, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33}, // 488  ( 296 ~ 309 )
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x94, 0x91, 0x97, 0x32, 0x31, 0x31, 0x31, 0x2F, 0x32}, // 465  ( 282 ~ 295 )
	{0x61, 0xF0, 0x27, 0x24, 0x3B, 0xB6, 0x33, 0x69, 0x12, 0x7A, 0xFF, 0x8D, 0x8A, 0x8F, 0x30, 0x2F, 0x30, 0x2E, 0x2D, 0x2F}, // 443  ( 256 ~ 281 )
};
	...
	*level_key = LEVEL1_KEY;
	...
	switch (vdd->panel_revision) {
		case 'A':
			...
			break;
		case 'B' ... 'D':
			memcpy(&hbm_irc_cmds->cmds[0].payload[1], irc_hbm_para_revB[para_idx], 20);
			break;
		default: /* Rev. E ~ */
			memcpy(&hbm_irc_cmds->cmds[0].payload[1], irc_hbm_para_revE[para_idx], 20);
			break;
	}
...
static void mdss_panel_multires(struct samsung_display_driver_data *vdd)
{
	if(vdd->multires_stat.prev_mode != vdd->multires_stat.curr_mode)
	{
		...
		SS_XLOG(vdd->multires_stat.prev_mode, vdd->multires_stat.curr_mode);
...
static void samsung_copr_read(struct samsung_display_driver_data *vdd)
{
	...
	if (vdd->copr.copr_data && vdd->display_status_dsi[DISPLAY_1].wait_actual_disp_on) {
		...
		/* Logging SS XLOG incase of normal on only */
		if (vdd->vdd_blank_mode[DISPLAY_1] == FB_BLANK_UNBLANK)
			SS_XLOG(vdd->copr.copr_data);
	}
...
static void  mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3HA6_AMB632NF01;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3HA6_AMB632NF01_hmt;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3HA6_AMB632NF01_WQHD";
