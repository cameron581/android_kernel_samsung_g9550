/*
 * sm5720_fuelgauge.h
 * Samsung SM5720 Fuel Gauge Header
 *
 * Copyright (C) 2015 Samsung Electronics, Inc.
 *
 * This software is sm5720 under the terms of the GNU General Public
...
#define FG_TABLE_LEN			0xF//real table length -1
